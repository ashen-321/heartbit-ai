...
@mcp_server.tool()
async def search_pubmed(request: PubMedSearchRequest) -> List[PubMedArticle]:
    ...
    try:
        ...
        fetch_response = await http_client.get(fetch_url, params=fetch_params)
...
def _parse_pubmed_xml(xml_data: str) -> List[PubMedArticle]:
